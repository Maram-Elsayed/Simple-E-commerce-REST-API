...
router.get("/:categoryId",CategoryController.getCategory ,CategoryController.get_category_products, CategoryController.display_category_products);

router.delete("/:categoryId",checkAuth, checkAdmin,CategoryController.delete_category);

router.get("/", CategoryController.view_all_categories);

router.get("/category-list/:categoryId", CategoryController.view_subcategories);
